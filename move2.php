...
<body>
    ...
    <div class="image_upload_div">
        ...
        <p><b>URL: </b><input name="" id="foo" type="text"
                value="<?php echo "http://assuncaopromotora.com/move2/".$urlacesso?>" size="70">
            <button class="btn" data-clipboard-action="copy" data-clipboard-target="#foo">Copiar URL</button>
        </p>
